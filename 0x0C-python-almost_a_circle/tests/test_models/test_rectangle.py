...
Unittest classes:
    TestRectangle_instantiation - line 2Unittest classes:
...
class TestRectangle_instantiation(unittest.TestCase):
    ...
    def test_height_getter(self):
        r = Rectangle(5, 7, 7, 5, 1)
        self.assertEqual(7, r.heightdef test_height_setter(self):
        r = Rectangle(5, 7, 7, 5, 1)
        r.height = 10
...
class TestRectangle_x(unittest.TestCase):
    ...
    def test_memoryview_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):Rectangle(1, 2, bytearray(b'abcdefg'))
...
class TestRectangle_area(unittest.TestCase):
    ...
    def test_area_large(self):
        r = Rectangle(999999999999999, 999999999999999999, 0, 0, 1)self.assertEqual(999999999999998999000000000000001, r.area())
...
def test_update_kwargs_two(self):
    ...
    def test_update_kwargs_invalid_y_type(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            r.update(y="invalid")def test_update_kwargs_y_negative(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "y must be >= 0"):
            r.update(y=-5)
